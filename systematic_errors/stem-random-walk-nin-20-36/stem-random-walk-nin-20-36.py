            ...
            with tf.Session(config=sess_config) as sess:
                ...
                while True:
                    ...
                    while time.time()-time0 < modelSavePeriod:
                        ...
                        dir43 = "//flexo.ads.warwick.ac.uk/Shared41/Microscopy/Jeffrey-Ede/models/stem-random-walk-nin-20-43/"
                        input = imread(dir43+f"final_input-{counter}.tif", mode="F")
                        _img[0] = np.reshape(input, _img[0].shape)
