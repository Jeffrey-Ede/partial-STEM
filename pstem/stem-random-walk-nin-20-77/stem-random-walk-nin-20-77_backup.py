...
model_dir = "//ads.warwick.ac.uk/shared/HCSS6/Shared305/Microscopy/Jeffrey-Ede/models/stem-random-walk-nin-20-77/"
            ...
            with tf.Session(config=sess_config) as sess:
                ...
                while True:
                    ...
                    while time.time()-time0 < modelSavePeriod:
                        ...
                        message = "NiN-77, Iter: {}, MSE_in: {}, MSE: {}, Wass G: {}, Wass D: {}, Val: {}".format(
